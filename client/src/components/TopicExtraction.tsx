...
export default function TopicExtraction() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-4 sm:p-6 space-y-6">
      ...
      <div
        className={`bg-white dark:bg-[#181818] rounded-2xl p-6 sm:p-8 shadow-lg border border-gray-200/50 dark:border-gray-800/50 transition-all duration-500 ${
          sentimentLoading
      ...
      >
        ...
        <p className="mt-6 sm:mt-8 text-center md:text-left text-xs sm:text-sm font-normal text-gray-500 dark:text-gray-400 flex items-center justify-center md:justify-start gap-2">
          ...
          These keywords represent the most frequently discussed subjects in the
